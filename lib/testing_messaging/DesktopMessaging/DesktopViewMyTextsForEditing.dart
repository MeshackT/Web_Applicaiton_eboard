...
import 'package:yueway/testing_messaging/ViewMyTextsForEditing.dart';

import '../../AllNew/model/ConnectionChecker.dart';
import '../../AllNew/shared/constants.dart';
import '../messaging.dart';

class DesktopViewMyTextsForEditing extends StatefulWidget {
  const DesktopViewMyTextsForEditing({Key? key}) : super(key: key);

  @override
  State<DesktopViewMyTextsForEditing> createState() =>
      _DesktopViewMyTextsForEditingState();
}

class _DesktopViewMyTextsForEditingState
    extends State<DesktopViewMyTextsForEditing> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth < Utils.mobileWidth) {
        return const ViewMyTextsForEditing();
      } else {
        return Scaffold(
          body: SafeArea(
            child: Container(
                        ...
                        OutlinedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) =>
                                    const DesktopViewMyTextsForEditing(),
                              ),
                            );
                          },
                          style: buttonRound,
