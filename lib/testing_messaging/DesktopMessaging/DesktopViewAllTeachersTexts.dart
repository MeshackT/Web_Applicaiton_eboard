...
class DesktopViewAllTeachersTexts extends StatefulWidget {
  const DesktopViewAllTeachersTexts({Key? key}) : super(key: key);

  @override
  State<DesktopViewAllTeachersTexts> createState() =>
      _DesktopViewAllTeachersTextsState();
}

class _DesktopViewAllTeachersTextsState
    extends State<DesktopViewAllTeachersTexts> {
