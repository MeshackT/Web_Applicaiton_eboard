...
import 'package:yueway/testing_messaging/DesktopMessaging/DesktopViewAllTeachersMessages.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth < Utils.mobileWidth) {
        ...
        return const DesktopViewAllTeachersMessages();
      }
    });
  }
