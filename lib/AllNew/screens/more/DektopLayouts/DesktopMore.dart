...
class DesktopMore extends StatefulWidget {
  const DesktopMore({Key? key}) : super(key: key);

  @override
  State<DesktopMore> createState() => _DesktopMoreState();
}

class _DesktopMoreState extends State<DesktopMore> {
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (emailForEnquiry.text.isEmpty ||
                                          ...
                                          await identityDocument.set({
                                            "emailForEnquiry": emailForEnquiry
                                                .text
                                                .trim()
                                                .toLowerCase(),
                                            "primaryContact":
  ...
  //TODO Enquiry  details hr/none teacher
  // web
  DesktopShowSheetForAddingEnquiries(BuildContext context) {
    //controllers
    TextEditingController emailForEnquiry = TextEditingController();
    TextEditingController primaryContact = TextEditingController();
    TextEditingController secondaryContact = TextEditingController();
