import 'package:Eboard/AllNew/screens/gradeList/registeredLearners/DetailedMarks.dart';
...
class DesktopGrade12 extends StatefulWidget {
  const DesktopGrade12({Key? key}) : super(key: key);
  static const routeName = '/grade12';

  @override
  State<DesktopGrade12> createState() => _DesktopGrade12State();
}

class _DesktopGrade12State extends State<DesktopGrade12> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth < Utils.mobileWidth) {
        indexList.clear();
        showMarks = false;
        return const Grade12();
      } else {
        return Scaffold(
          appBar: AppBar(
            title: const Text(
              "Grade 12 registered learner's",
              style: TextStyle(
                fontSize: 16,
                              ...
                              child: StreamBuilder(
                                ...
                                builder: (ctx, streamSnapshot) {
                                  if (streamSnapshot.connectionState ==
                                    ...
                                    return Center(
                                      child: Text(
                                        "No list of grade 12 learners yet.",
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      if (index >= 0 &&
                                        ...
                                        String surnameOfL = documents[index]
                                                ['secondName'] ??
                                            "";
                                        String gradeOfL =
                                            documents[index]['grade'] ?? "";

                                        // Rest of your code that uses nameOfL, surnameOfL, and gradeOfL
