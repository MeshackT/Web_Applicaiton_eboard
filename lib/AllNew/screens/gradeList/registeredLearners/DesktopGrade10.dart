...
class DesktopGrade10 extends StatefulWidget {
  const DesktopGrade10({Key? key}) : super(key: key);
  static const routeName = '/grade12';

  @override
  State<DesktopGrade10> createState() => _DesktopGrade10State();
}

class _DesktopGrade10State extends State<DesktopGrade10> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      if (constraints.maxWidth < Utils.mobileWidth) {
        return const Grade10();
      } else {
        return Scaffold(
          appBar: AppBar(
            title: const Text(
              "Grade 10 registered learner's",
              style: TextStyle(
                fontSize: 16,
