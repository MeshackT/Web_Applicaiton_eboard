...
class DesktopGrade8 extends StatefulWidget {
  const DesktopGrade8({Key? key}) : super(key: key);
  static const routeName = '/grade12';

  @override
  State<DesktopGrade8> createState() => _DesktopGrade8State();
}

class _DesktopGrade8State extends State<DesktopGrade8> {
                              ...
                              child: StreamBuilder(
                                ...
                                builder: (ctx, streamSnapshot) {
                                  if (streamSnapshot.connectionState ==
                                    ...
                                    return Center(
                                      child: Text(
                                        "No list of grade 8 learners yet.",
        ...
        if (data is Map) {
          ...
          data.forEach((key, value) {
            ...
            if (key == _userSubject) {
              ...
              logger.i("$showMarks and $showMarks2 $nameParse $_userSubject");
            } else {
              // setState(() {
              //   showMarks = false;
              //   showMarks2 = false;
