...
class DesktopTeachersProfile extends StatefulWidget {
  const DesktopTeachersProfile({Key? key}) : super(key: key);

  @override
  State<DesktopTeachersProfile> createState() => _DesktopTeachersProfileState();
}

class _DesktopTeachersProfileState extends State<DesktopTeachersProfile> {
  String teachersName = "";
