...
class DesktopViewNotifications extends StatefulWidget {
  String subjectOfTeacherPassed = "";

  DesktopViewNotifications({Key? key, required this.subjectOfTeacherPassed})
      : super(key: key);

  @override
  State<DesktopViewNotifications> createState() =>
      _DesktopViewNotificationsState();
}

class _DesktopViewNotificationsState extends State<DesktopViewNotifications> {
