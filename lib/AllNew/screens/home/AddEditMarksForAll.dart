...
class AddEditForAll extends StatefulWidget {
  ...
  String nameOfLearnerFromFirebase = "";

  AddEditForAll({
    Key? key,
    required this.nameOfLearnerFromFirebase,
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Scaffold(
        appBar: AppBar(
            title: Text(
              "Enter marks or update for ${widget.nameOfLearnerFromFirebase} ",
              style: const TextStyle(
                  fontWeight: FontWeight.w500, fontSize: 16, letterSpacing: 2),
            ),
            leading: IconButton(
              onPressed: () {
                Utils.logger.i("pressed");
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              var subjectData = allSubjects[key];
                                                                              ...
                                                                              // update the data
                                                                              subjectData[0]["tests"]["test1mark"] = testOneMark.text;
                                                                              subjectData[0]["tests"]["test2mark"] = testTwoMark.text;
                                                                              subjectData[0]["tests"]["test3mark"] = testThreeMark.text;
                                                                              subjectData[0]["tests"]["test4mark"] = testFourMark.text;
                                                                          ...
                                                                          if (!foundCatIndex) {
                                                                            ...
                                                                            logger.i('No $subjectName index found');
                                                                            scaffoldContext.showSnackBar(SnackBar(
                                                                              content: Text('The learner is not registered to do $subjectName'),
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[0]["assignments"]["assignment1mark"] = assignmentOneMark.text;
                                                                              subjectData[0]["assignments"]["assignment2mark"] = assignmentTwoMark.text;
                                                                              subjectData[0]["assignments"]["assignment3mark"] = assignmentThreeMark.text;
                                                                              subjectData[0]["assignments"]["assignment4mark"] = assignmentFourMark.text;
                                                                              // Update the "allSubjects" field with the modified map
                                                                              await identityDocument.set({
                                                                                'allSubjects': allSubjects
                                                                              }, SetOptions(merge: true)).then(
                                                                          ...
                                                                          if (!foundCatIndex) {
                                                                            ...
                                                                            logger.i('No $subjectName index found');
                                                                            scaffoldContext.showSnackBar(SnackBar(
                                                                              content: Text('Poor internet connection or the learner is not registered to do $subjectName'),
                                                                              duration: const Duration(seconds: 1),
                                                                            ));
                                                                          }
                                                                        } else {
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[0]["exams"]["exam1mark"] = examOneMark.text;
                                                                              subjectData[0]["exams"]["exam2mark"] = examTwoMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // update the data
                                                                              subjectData[1]["tests"]["test1mark"] = termTwoTestOneMark.text;
                                                                              subjectData[1]["tests"]["test2mark"] = termTwoTestTwoMark.text;
                                                                              subjectData[1]["tests"]["test3mark"] = termTwoTestThreeMark.text;
                                                                              subjectData[1]["tests"]["test4mark"] = termTwoTestFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[1]["assignments"]["assignment1mark"] = termTwoAssignmentOneMark.text;
                                                                              subjectData[1]["assignments"]["assignment2mark"] = termTwoAssignmentTwoMark.text;
                                                                              subjectData[1]["assignments"]["assignment3mark"] = termTwoAssignmentThreeMark.text;
                                                                              subjectData[1]["assignments"]["assignment4mark"] = termTwoAssignmentFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[1]["exams"]["exam1mark"] = termTwoExamOneMark.text;
                                                                              subjectData[1]["exams"]["exam2mark"] = termTwoExamTwoMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // update the data
                                                                              subjectData[2]["tests"]["test1mark"] = termThreeTestOneMark.text;
                                                                              subjectData[2]["tests"]["test2mark"] = termThreeTestTwoMark.text;
                                                                              subjectData[2]["tests"]["test3mark"] = termThreeTestThreeMark.text;
                                                                              subjectData[2]["tests"]["test4mark"] = termThreeTestFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[2]["assignments"]["assignment1mark"] = termThreeAssignmentOneMark.text;
                                                                              subjectData[2]["assignments"]["assignment2mark"] = termThreeAssignmentTwoMark.text;
                                                                              subjectData[2]["assignments"]["assignment3mark"] = termThreeAssignmentThreeMark.text;
                                                                              subjectData[2]["assignments"]["assignment4mark"] = termThreeAssignmentFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[2]["exams"]["exam1mark"] = termThreeExamOneMark.text;
                                                                              subjectData[2]["exams"]["exam2mark"] = termThreeExamTwoMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // update the data
                                                                              subjectData[3]["tests"]["test1mark"] = termFourTestOneMark.text;
                                                                              subjectData[3]["tests"]["test2mark"] = termFourTestTwoMark.text;
                                                                              subjectData[3]["tests"]["test3mark"] = termFourTestThreeMark.text;
                                                                              subjectData[3]["tests"]["test4mark"] = termFourTestFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[3]["assignments"]["assignment1mark"] = termFourAssignmentOneMark.text;
                                                                              subjectData[3]["assignments"]["assignment2mark"] = termFourAssignmentTwoMark.text;
                                                                              subjectData[3]["assignments"]["assignment3mark"] = termFourAssignmentThreeMark.text;
                                                                              subjectData[3]["assignments"]["assignment4mark"] = termFourAssignmentFourMark.text;
                                                                        ...
                                                                        if (allSubjects
                                                                          ...
                                                                          for (var key
                                                                            ...
                                                                            if (key ==
                                                                              ...
                                                                              // do something with the data, such as print it
                                                                              // update the data
                                                                              subjectData[3]["exams"]["exam1mark"] = termFourExamOneMark.text;
                                                                              subjectData[3]["exams"]["exam2mark"] = termFourExamTwoMark.text;
