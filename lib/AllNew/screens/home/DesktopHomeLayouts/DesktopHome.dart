...
import '../../gradeList/registeredLearners/DesktopGrade11.dart';
                                                              ...
                                                              if (data is Map) {
                                                                ...
                                                                if (data.containsKey(
                                                                  ...
                                                                  if (snapshot.data() !=
                                                                          null &&
                                                                      docExists) {
                                                                    if ((docRef.collection('learnersData').where(
                                                                            'teachersID',
                                                                            arrayContains:
                                                                                user!.uid) !=
                                                                        null)) {
                                                                      ...
                                                                      if (index1 !=
                                                                        ...
                                                                        await docRef.update({
                                                                          'allSubjects':
                                                                            ...
                                                                            Fluttertoast.showToast(msg: 'Error updating Map field: $error'));
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Center(child: buildMenueItems(context)),
              ],
            ),
          ),
        ),
